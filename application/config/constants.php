...
define('NAV_ADM_APPROVED_ACTIVITIES', 'adm_approved_activities');
define('NAV_ADM_PROPOSED_ACTIVITIES', 'adm_proposed_activities');
...
define('NAV_USR_TRACK_PROPOSALS', 'track_proposals');
define('NAV_USR_STATUS', 'usr_status');
